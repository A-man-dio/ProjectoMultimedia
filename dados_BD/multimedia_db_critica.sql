...
CREATE TABLE `critica` (
  ...
  `comentario` longtext,
  `data_critica` datetime(6) DEFAULT NULL,
  `pontuacao` int DEFAULT NULL,
  `id_album` int NOT NULL,
  `id_utilizador` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK643d2syg9vv0q9honoc2b1taf` (`id_album`),
  KEY `FKgq1xxb6hl4oq1r5ispea0f25b` (`id_utilizador`),
  CONSTRAINT `FK643d2syg9vv0q9honoc2b1taf` FOREIGN KEY (`id_album`) REFERENCES `album` (`id`),
  CONSTRAINT `FKgq1xxb6hl4oq1r5ispea0f25b` FOREIGN KEY (`id_utilizador`) REFERENCES `utilizador` (`id`)
